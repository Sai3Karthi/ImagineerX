...
excel_file_path = "ImagineerX_final\\testdata.xlsx"
df = pd.read_excel(excel_file_path)

# Set the path to the service account key file
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "ImagineerX_final\iron-burner-412609-1de637da5b5f.json"
...
def display_table():
    try:
        ...
        excel_file_path = "ImagineerX_final\\testdata.xlsx"  # Replace with the path to your predefined Excel file
        df = pd.read_excel(excel_file_path)
...
def aicaller():
    if request.method == 'POST':
        try:
            ...
            excel_file_path = "ImagineerX_final\\testdata.xlsx"  # Replace with the path to your Excel file
